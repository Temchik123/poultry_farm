...
if(empty($login) or empty($password) or empty($dpassword) or empty($email))
{
 ?><html>
         ...
         <head><meta http-equiv="Content-Type" content="text/html;"><title>Error</title></head>
		  <body>
...
$add_user="INSERT INTO `polutry_farm`.`users` (`id`, `login`, `password`, `email`, `fio`, `level` ) VALUES ('', '$login', '$password', '$email', '$fio', '0')";
//echo $add_user;
